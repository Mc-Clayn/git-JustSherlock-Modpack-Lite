; *** Inno Setup version 5.5.1+ Russian messages ***
;
...
ExitSetupMessage=Установка не завершена. Если вы выйдете, программа не будет установлена.%n%nВыйти из программы установки?
AboutSetupMenuItem=&О программе...
AboutSetupTitle=О программе
AboutSetupMessage=%1, версия %2%n%3%n%nСайт %1:%n%4
AboutSetupNote=Installator source code:%nhttps://bitbucket.org/_McClayn/soundpack%n©2015-2020 Dmitriy Balaganskiy.
...
ComponentSize1=%1 Кб
ComponentSize2=%1 Мб
ComponentsDiskSpaceMBLabel=Требуется не менее [mb] Мб на диске.
...
UninstallProgram=Деинсталляция %1
