...
//#endif
Source: "files\mods\TWEAKER\mods\1.36.1.0\tweaker\tweakerClouds.mtmod"; DestDir: "{app}\mods\tweaker\{code:ggPatch}"; Flags: ignoreversion recursesubdirs createallsubdirs nocompression; BeforeInstall: SetInstallStatus('instStatusTweaker'); Check: ComponentsTweakerChecked('itemTweakerSkybox');
Source: "files\mods\TWEAKER\mods\1.36.1.0\tweaker\tweakerArmorHit.mtmod"; DestDir: "{app}\mods\tweaker\{code:ggPatch}"; Flags: ignoreversion recursesubdirs createallsubdirs nocompression; BeforeInstall: SetInstallStatus('instStatusTweaker'); Check: ComponentsTweakerChecked('itemTweakerTankHit');
Source: "files\mods\TWEAKER\mods\1.36.1.0\tweaker\tweakerShots.mtmod"; DestDir: "{app}\mods\tweaker\{code:ggPatch}"; Flags: ignoreversion recursesubdirs createallsubdirs nocompression; BeforeInstall: SetInstallStatus('instStatusTweaker'); Check: ComponentsTweakerChecked('itemTweakerShootSmoke');
Source: "files\mods\TWEAKER\mods\1.36.1.0\tweaker\tweakerSkyFog.mtmod"; DestDir: "{app}\mods\tweaker\{code:ggPatch}"; Flags: ignoreversion recursesubdirs createallsubdirs nocompression; BeforeInstall: SetInstallStatus('instStatusTweaker'); Check: ComponentsTweakerChecked('itemTweakerFog');
Source: "files\mods\TWEAKER\mods\1.36.1.0\tweaker\tweakerSmokeDead.mtmod"; DestDir: "{app}\mods\tweaker\{code:ggPatch}"; Flags: ignoreversion recursesubdirs createallsubdirs nocompression; BeforeInstall: SetInstallStatus('instStatusTweaker'); Check: ComponentsTweakerChecked('itemTweakerDestroyedSmoke');
Source: "files\mods\TWEAKER\mods\1.36.1.0\tweaker\tweakerExhaust.mtmod"; DestDir: "{app}\mods\tweaker\{code:ggPatch}"; Flags: ignoreversion recursesubdirs createallsubdirs nocompression; BeforeInstall: SetInstallStatus('instStatusTweaker'); Check: ComponentsTweakerChecked('itemTweakerExhaustSmoke');
Source: "files\mods\TWEAKER\mods\1.36.1.0\tweaker\tweakerExplosion.mtmod"; DestDir: "{app}\mods\tweaker\{code:ggPatch}"; Flags: ignoreversion recursesubdirs createallsubdirs nocompression; BeforeInstall: SetInstallStatus('instStatusTweaker'); Check: ComponentsTweakerChecked('itemTweakerShells');
Source: "files\mods\TWEAKER\mods\1.36.1.0\tweaker\tweakerGraphicsSettings.mtmod"; DestDir: "{app}\mods\tweaker\{code:ggPatch}"; Flags: ignoreversion recursesubdirs createallsubdirs nocompression; BeforeInstall: SetInstallStatus('instStatusTweaker'); Check: ComponentsTweakerChecked('itemTweakerTrees');
Source: "files\mods\TWEAKER\mods\1.36.1.0\tweaker\tweakerGroundHit.mtmod"; DestDir: "{app}\mods\tweaker\{code:ggPatch}"; Flags: ignoreversion recursesubdirs createallsubdirs nocompression; BeforeInstall: SetInstallStatus('instStatusTweaker'); Check: ComponentsTweakerChecked('itemTweakerEmblems');
